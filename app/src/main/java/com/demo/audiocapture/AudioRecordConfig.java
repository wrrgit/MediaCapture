...
/**
 * @author wangrenran on 2021/9/25.
 */
public class AudioRecordConfig implements Serializable {
    /**
     * 录音格式 默认WAV格式
     */
    public static RecordFormat format = RecordFormat.WAV;
    /**
     * 通道数:默认单通道
     */
     ...
     * 位宽
     */
    public static int encodingConfig = AudioFormat.ENCODING_PCM_16BIT;
    ...
    public AudioRecordConfig(RecordFormat format) {
        this.format = format;
    }
     ...
     */
    public AudioRecordConfig(RecordFormat format, int channelConfig, int encodingConfig, int sampleRate) {
        this.format = format;
    ...
    public AudioRecordConfig setFormat(RecordFormat format) {
        this.format = format;
        return this;
    }
    ...
    public AudioRecordConfig setEncodingConfig(int encodingConfig) {
        this.encodingConfig = encodingConfig;
        return this;
    }
